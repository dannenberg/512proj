...
//public class ResourceManagerPlane extends java.rmi.server.UnicastRemoteObject
public class ResourceManagerPlane
implements ResourceManager {
    ...
    public static void main(String args[]) {
        ...
        if (args.length == 1) {
            ...
            System.out.println("Usage: java ResImpl.ResourceManagerPlane [port]");
            System.exit(1);
        }
        ...
        try 
        {
            ...
            ResourceManagerPlane obj = new ResourceManagerPlane();
            // dynamically generate the stub (client proxy)
            ResourceManager rm = (ResourceManager) UnicastRemoteObject.exportObject(obj, 0);

            // Bind the remote object's stub in the registry
            Registry registry = LocateRegistry.getRegistry(port);
            registry.rebind("Group13ResourceManagerPlane", rm);
    ...
    public ResourceManagerPlane() throws RemoteException {
    }
